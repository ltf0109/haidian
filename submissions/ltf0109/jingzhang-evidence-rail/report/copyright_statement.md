...
- **Conclusion**: all asset-level licenses used by this submission are documented above and in sources.json; the submission contains only agent-self-designed assets and cleared public/user-provided sources. Known gaps (on-site field evidence) are delegated to the professional/organizing team as non-blocking to-dos. A professional legal review is recommended before formal exhibition/publication.
