...
| 03 AI Innovation Ecosystem Map (appendix figure, **not in submission package**) | `multimodal-pack/generated visuals/03/...` | **not_audited** | Appendix-figure numbers were multimodal-inferred and are deprecated; **not verified by metrics.json**. Excluded from the submission package to avoid misleading figures. **Single trusted POI caliber = 55/262/62** (Zhongzhiyuan / AI Origin / Dazhongsi), recomputed from AMap POI within key_areas geometry (see assets/figures/ecosystem-map.en.png and metrics.json notes) |
