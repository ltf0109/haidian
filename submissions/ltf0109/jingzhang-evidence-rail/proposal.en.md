...
| 03 Autonomous Belt | Zhongzhiyuan AI Accelerator |依托京张铁路遗址段组织 9km 封闭测试车道，集成智能网联、车路协同与具身智能产业链，开展受限场景下的自动驾驶测试与展示|
| 04 Embodied AI Lab | Zhongzhiyuan AI Accelerator |群智算力工厂与多模态垂域大模型测试间，开展机器人代码改造与场景适配测试，支撑具身智能产业化|
| 05 Open-Source Hall | Beijing AI Origin Community (Wudaokou Core) |面向高校、开源社区与初创团队的开源模型发布与协作空间，提供模型发布、代码贡献展示与社区活动场地|
| 06 Academic Cross-Hub | Beijing AI Origin Community (Wudaokou Core) |链接高校与初创创新者，组织跨校创客社群、交叉学科工作坊与硬件/软件原型支持，承接高校成果的早期孵化|
| 07 Young Geek Street | Beijing AI Origin Community (Wudaokou Core) |面向青年开发者与极客的街头集市，提供原型展示、快速测试、社区交流与创客市集活动空间|
| 08 AI Ethics Gallery | Beijing AI Origin Community (Wudaokou Core) |以"真实问题+AI 艺术+伦理讨论"为主题的露天策展街区，结合代码开源与公共艺术，呈现 AI 伦理议题与公众参与|
| 09 Immersive Living | Dazhongsi AI Industry Cluster |面向公众的消费级 AI 应用体验空间，提供沉浸式交互演示、产品试用与科普活动|
| 10 Global Roadshow | Dazhongsi AI Industry Cluster |国际级路演发布大厅，配备金融对接、媒体发布与商务洽谈功能，服务国际企业与创业团队|
| 11 Phygital Block | Dazhongsi AI Industry Cluster |传统商业区叠加数字孪生与新兴业态的混合街区，探索虚实结合的消费与社交场景|
| 12 Smart Retail Hub | Dazhongsi AI Industry Cluster |以智慧终端与智能硬件体验为核心的 AI 商业街区，集成智能终端集群与场景化零售|
...
| 03 Autonomous Belt | Park operator |依托京张铁路遗址段组织 9km 封闭测试车道，集成智能网联、车路协同与具身智能产业链，开展受限场景下的自动驾驶测试与展示| Offline fallback to local cache; resource overuse triggers human scheduling | Account-free manual application |
| 04 Embodied AI Lab | Street + park operator |群智算力工厂与多模态垂域大模型测试间，开展机器人代码改造与场景适配测试，支撑具身智能产业化| Gap findings human-verified on site; adverse weather auto-degrades | Paper guide maps, human inquiry |
| 05 Open-Source Hall | Convention operator |面向高校、开源社区与初创团队的开源模型发布与协作空间，提供模型发布、代码贡献展示与社区活动场地| Content human-reviewed; over-capacity auto-throttles | Phone/counter booking |
| 06 Academic Cross-Hub | Park + municipal |链接高校与初创创新者，组织跨校创客社群、交叉学科工作坊与硬件/软件原型支持，承接高校成果的早期孵化| Water-level/energy anomaly auto-alerts + human response | Free open access, no threshold |
| 07 Young Geek Street | University tech-transfer office + park |面向青年开发者与极客的街头集市，提供原型展示、快速测试、社区交流与创客市集活动空间| Transformation matching human-mediated; data overreach auto-blocked | Campus service counters |
| 08 AI Ethics Gallery | Compliant operator |以"真实问题+AI 艺术+伦理讨论"为主题的露天策展街区，结合代码开源与公共艺术，呈现 AI 伦理议题与公众参与| Expired authorization auto-removed; disputes human-arbitrated | Human consultation, written materials |
| 09 Immersive Living | Merchants' association + street |面向公众的消费级 AI 应用体验空间，提供沉浸式交互演示、产品试用与科普活动| Merchants may opt out anytime; AI advice is reference only | Cash/human checkout in parallel |
| 10 Global Roadshow | Event committee + community |国际级路演发布大厅，配备金融对接、媒体发布与商务洽谈功能，服务国际企业与创业团队| Emergency plans human-led; over-threshold crowd auto-diversions | Free attendance, no account |
| 11 Phygital Block | Transport authority + operator |传统商业区叠加数字孪生与新兴业态的混合街区，探索虚实结合的消费与社交场景| Retrofit decisions human-reviewed; findings carry confidence labels | Barrier-free hotline feedback |
| 12 Smart Retail Hub | Public security + organizer |以智慧终端与智能硬件体验为核心的 AI 商业街区，集成智能终端集群与场景化零售| Alerts assist only; response is human-decided; data destroyed post-event | On-site staff on duty |
...
| 04 Scenario-Space-Operation Matrix | `assets/figures/scenario-matrix.png` |群智算力工厂与多模态垂域大模型测试间，开展机器人代码改造与场景适配测试，支撑具身智能产业化| All percentages and thresholds in the "EBIP Metrics & Deliverables" column (model-safety 100%, PUE ≤1.15, p99 ≤48ms, V2X 30%, robot penetration 50%, 15-min life-circle >92%, 8000 sqm immersive, 5,000 daily, +45% retail, etc.) are design-target/reference values **not listed in metrics.json** and do not constitute recomputable indicators; pending professional-team verification |
| 08 Offline Multimodal Sandbox | `report/proposal.html#interactive-sandbox`（静态版）；完整可交互版见 `multimodal-pack/generated visuals/08/京张循证轨_离线多模态交互沙盒_interactive.html` |以"真实问题+AI 艺术+伦理讨论"为主题的露天策展街区，结合代码开源与公共艺术，呈现 AI 伦理议题与公众参与| Single-file offline (no CDN/remote scripts), with proposal narrative, three-core layout, 12 scenarios, logo/palette and honor system |
...
| 03 AI Innovation Ecosystem Map (appendix figure, **not in submission package**) | `multimodal-pack/generated visuals/03/...` |依托京张铁路遗址段组织 9km 封闭测试车道，集成智能网联、车路协同与具身智能产业链，开展受限场景下的自动驾驶测试与展示| POI n=58/335/995, industry-cluster density 48.2%/31.0%/42.1%/51.0%, research density 31.0%/38.6%/28.5% are inferred values from multimodal generation, **not verified by metrics.json**; this version **excludes it from the submission package** to avoid misleading numbers, kept under multimodal-pack as design inspiration, pending professional-team verification before possible inclusion |
...
| 01 Algorithm Sandbox | 合规性判定按 formal（4 个官方标准）/ provisional（沙盒自报）/ unknown（未通过红队）三档；沙盒仅展示已通过红队测试的产出 | 若红队测试通过率 < 95%，自动延期发布并触发人工复测；回退条件：合规风险事件 | 沙盒内每日自动跑 4 gate（红队/泄漏/偏见/越权），任一 fail 即关闭展示 | 算法输出违规内容 → 立即下架 + 启动人工调查 + 暂停 7 天复审 |
| 02 Compute Co-op | 算力调度结果按 official（任务方授权）/ provisional（队列优先级）/ unknown（资源争抢）三档；调度记录全部留痕 | 若某时段 P99 > 50ms 或资源争抢 > 30%，自动回退到单租户队列并报警 | 每日 4 gate（任务授权/数据隔离/资源公平/能耗） | 算力被滥用或超限 → 立即冻结账户 + 30 天审计 |
| 03 Autonomous Belt | 智驾测试按 official（合规路测许可）/ provisional（指定路段封闭测试）/ unknown（待路测）三档；测试数据全量归档 |依托京张铁路遗址段组织 9km 封闭测试车道，集成智能网联、车路协同与具身智能产业链，开展受限场景下的自动驾驶测试与展示| 每日 4 gate（路测合规/数据脱敏/车辆状态/应急预案） | 测试车辆事故 → 立即暂停所有车外决策 + 启动人工接管 + 通报监管 |
| 04 Embodied AI Lab | 机器人行为按 official（场景合规）/ provisional（限定空间测试）/ unknown（待验证）三档；机器人代码测试可重放 |群智算力工厂与多模态垂域大模型测试间，开展机器人代码改造与场景适配测试，支撑具身智能产业化| 每日 4 gate（场景合规/安全/可重放/可审计） | 机器人未授权动作 → 立即断电 + 启动人工回收 + 重新安全评估 |
| 05 Open-Source Hall | 发布内容按 official（许可证合规）/ provisional（社区审议）/ unknown（未审）三档；贡献数据全公开 |面向高校、开源社区与初创团队的开源模型发布与协作空间，提供模型发布、代码贡献展示与社区活动场地| 每日 4 gate（许可证/代码质量/可重放/社区反馈） | 许可证违规 → 立即下架 + 启动法务审查 + 暂停社区入口 |
| 06 Academic Cross-Hub | 跨学科项目按 official（高校备案）/ provisional（导师签字）/ unknown（待评）三档 |链接高校与初创创新者，组织跨校创客社群、交叉学科工作坊与硬件/软件原型支持，承接高校成果的早期孵化| 每日 4 gate（学籍/项目合规/导师签字/知识产权） | 成果归属争议 → 立即冻结项目 + 启动高校协调 + 重新分配 |
| 07 Young Geek Street | 青年活动按 official（学校/单位推荐）/ provisional（自主申报）/ unknown（待筛选）三档 |面向青年开发者与极客的街头集市，提供原型展示、快速测试、社区交流与创客市集活动空间| 每日 4 gate（活动合规/安全/年龄合规/导师在场） | 活动违规 → 立即停止 + 启动人工审查 + 通报学校 |
| 08 AI Ethics Gallery | 策展内容按 official（伦理委员会审议）/ provisional（策展团队共识）/ unknown（待议）三档；展览全程录像 |以"真实问题+AI 艺术+伦理讨论"为主题的露天策展街区，结合代码开源与公共艺术，呈现 AI 伦理议题与公众参与| 每日 4 gate（伦理/版权/隐私/安全） | 伦理违规 → 立即闭展 + 启动伦委会复审 + 道歉声明 |
| 09 Immersive Living | 体验内容按 official（文化部门备案）/ provisional（合作方授权）/ unknown（待审）三档 |面向公众的消费级 AI 应用体验空间，提供沉浸式交互演示、产品试用与科普活动| 每日 4 gate（内容合规/安全/无障碍/版权） | 体验事故 → 立即关停 + 启动人工救护 + 通报监管 |
| 10 Global Roadshow | 路演内容按 official（金融监管备案）/ provisional（合作方授权）/ unknown（待审）三档 |国际级路演发布大厅，配备金融对接、媒体发布与商务洽谈功能，服务国际企业与创业团队| 每日 4 gate（金融合规/版权/无障碍/安全） | 路演违规 → 立即停止 + 启动法务审查 + 通报监管 |
| 11 Phygital Block | 商业活动按 official（市场监管备案）/ provisional（商户自主）/ unknown（待审）三档 |传统商业区叠加数字孪生与新兴业态的混合街区，探索虚实结合的消费与社交场景| 每日 4 gate（商户合规/消费者权益/无障碍/安全） | 商户违规 → 立即关停 + 启动人工审查 + 通报市场监管 |
| 12 Smart Retail Hub | 终端设备按 official（公安备案）/ provisional（合作方授权）/ unknown（待审）三档 |以智慧终端与智能硬件体验为核心的 AI 商业街区，集成智能终端集群与场景化零售| 每日 4 gate（设备合规/数据安全/无障碍/安全） | 设备事故 → 立即关停 + 启动人工回收 + 通报公安 |
